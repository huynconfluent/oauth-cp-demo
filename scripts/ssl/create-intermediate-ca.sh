...
# OPENSSL_BIN=openssl WORK_DIR=intermediate_ca ./create-intermediate-ca.sh <chain_count> <base_subject> <conf> "<issuer_key>" "<issuer_cert>"
# OPENSSL_BIN=openssl WORK_DIR=intermediate_ca ./create-intermediate-ca.sh 1 "/C=US/ST=CA/O=Confluent Demo/OU=Global Technical Support/CN=Intermediate" ./configs/intermediate_ca.cnf ../generated/root_ca/private/ca.key ../generated/root_ca/certs/ca.pem
...
CONF=$3
ROOT_SUBJECT=$2
PRIVATE_INTERMEDIATE_KEY_PATH=$WORK_DIR/private
INTERMEDIATE_CSR_PATH=$WORK_DIR/csr
PUBLIC_INTERMEDIATE_CERT_PATH=$WORK_DIR/certs
ISSUER_KEY=$4
ISSUER_CERT=$5
